...
This License does not grant any right to use the names, trademarks, service marks, logos, branding, or project names of NewPythonX Studio except as required for attribution under this License. All such rights are reserved.
...
You may modify the Software for any lawful purpose. You are solely responsible for any modifications you make and for compliance with any third-party terms, policies, or legal requirements applicable to your modified version.

**Sharing modified versions.**

You may distribute modified versions of the Software only if:

1. The modified version remains licensed under this License.
